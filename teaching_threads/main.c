...
int main(int argc, char *argv[]) {
  ...
  bool passed = verify(ret_value, list_copy, reducer_func, base_case, list_len);

  if (passed) {
    printf("Congratulations you have succesfully ran par_reduce with %s on a "
           "list with %zu elements, and %zu threads\n",
